...
export const TOPICS: readonly Topic[] = [
  {
    id: 'best-advice',
    text: 'The best piece of advice you have ever ignored.',
    category: 'personal',
  },
  {
    id: 'overrated',
    text: 'Something everyone loves that you find overrated.',
    category: 'opinion',
  },
  {
    id: 'skill-one-week',
    text: 'A skill you could teach someone in a single week.',
    category: 'personal',
  },
  {
    id: 'delete-one-invention',
    text: 'If you could uninvent one thing, what would it be?',
    category: 'hypothetical',
  },
  {
    id: 'changed-my-mind',
    text: 'Something you used to believe strongly and no longer do.',
    category: 'personal',
  },
  { id: 'luck-vs-work', text: 'How much of success is luck?', category: 'abstract' },
  {
    id: 'last-day-phone',
    text: 'You lose your phone for a month. What changes?',
    category: 'hypothetical',
  },
  {
    id: 'small-kindness',
    text: 'A small kindness from a stranger that stayed with you.',
    category: 'personal',
  },
  {
    id: 'school-should-teach',
    text: 'One thing schools should teach but do not.',
    category: 'opinion',
  },
  {
    id: 'what-is-home',
    text: 'What makes a place feel like home?',
    category: 'abstract',
  },
];
